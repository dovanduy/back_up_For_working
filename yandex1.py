...
try:         
    ...
    d(text="飞行模式").click()
    time.sleep(2)
    #os.system('adb -s 5dae1d9 shell settings put global airplane_mode_on 1')
    #os.system('adb -s 5dae1d9 shell settings put global airplane_mode_on 0')
    d.press('home')
    # d(text="手机查看器").click()
    # time.sleep(1)
    # d(text="一键改机").click()
    # time.sleep(1)
    # d.press('home')
    os.system("adb -s 5dae1d9 uninstall ru.yandex.mail")
    time.sleep(1)
    os.system("adb -s 5dae1d9 install /home/administator/下载/ru.yandex.mail_43964.apk")
    ...
    text = requests.get('https://www.fakenamegenerator.com/gen-male-us-us.php', timeout=10).text
