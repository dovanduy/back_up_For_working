...
try:         
    ...
    # time.sleep(1)
    # d.press('home')
    os.system("adb -s 4d51746e uninstall ch.protonmail.android")
    time.sleep(1)
    os.system("adb -s 4d51746e install /home/administator/protonmail.apk")
    time.sleep(5)
    ...
    # time.sleep(random.random()*240+240)
    # d(text="设置").click()
    # d(text="飞行模式").click()
    # time.sleep(2)
    # d(text="飞行模式").click()
